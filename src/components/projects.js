    ...
    return (
      <div id={styles.wrapper} style={{left: "-200px"}}>
        ...
        <div id={styles['projects-wrap']}>
          <Project screenshot={perntodo} title="PERN stack todo app" icons={['html', 'css', 'js', 'react', 'express', 'heroku', 'postgres']} subTitle="HTML, CSS, JS" liveLink="https://deploy-pern-todo.herokuapp.com/" gitLink="https://github.com/dkhole/pern-todo" info="Built with PostgreSQL, Express, React and Nodejs following a RESTful architecture. If you dont want to create an account feel free to test using email: admin@gmail.com pass: admin."/>
